...
<nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-col lg:flex-row items-center ">
                <li>
                    <a href="/">
                        <img src="/img/news365.png" alt="logo" class="w-34 h-32">
                    </a>
                </li>
                <li class="lg:ml-16 mt-3 ">
                    <a href="/?news=inter" class="hover:text-gray-300">Internacionales</a>
                </li>
                <li class="lg:ml-6 mt-3 ">
